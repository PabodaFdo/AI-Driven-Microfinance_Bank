...
public class Applicant {
    ...
    // AI Model fields (Phase 1)
    @Min(value = 18, message = "Age must be at least 18")
    @Max(value = 100, message = "Age must be at most 100")
    private Integer age;  // Auto-calculated from NIC

    @Pattern(regexp = "^(High School|Bachelor's|Master's|PhD)$",
        message = "Education must be one of: High School, Bachelor's, Master's, PhD")
    private String education;  // New field for AI model
