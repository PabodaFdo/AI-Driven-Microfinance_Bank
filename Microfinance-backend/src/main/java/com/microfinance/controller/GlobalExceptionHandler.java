...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleBusiness(BusinessException ex) {
        // Check if it's an authorization-related business exception
        String message = ex.getMessage() != null ? ex.getMessage() : "";
        if (message.contains("Only") && message.contains("can") || message.contains("not permitted")) {
    ...
    public ResponseEntity<Map<String, Object>> handleValidation(MethodArgumentNotValidException ex) {
        ...
        // Create field-level error mapping
    ...
    public ResponseEntity<Map<String, Object>> handleGeneric(Exception ex) {
        return error(HttpStatus.INTERNAL_SERVER_ERROR, ex.getMessage() == null ? "Unexpected server error" : ex.getMessage());
    }
