...
@Data
public class RecommendationManualUpdateRequest {
    ...
    // NOTE: feasibility is intentionally EXCLUDED from manual updates
    // Feasibility remains system-generated and should not be manually overridden
